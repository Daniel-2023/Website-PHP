...
if(isset($_POST['add_category_btn']))
{
    ...
    if($cate_query_run)
    {
        ...
        redirect("add-category.php", "Категорията добавена успешно");
    }
    else
    {
        redirect("add-category.php", "Възникна някаква грешка");
    }
}
else if(isset($_POST['update_category_btn']))
{
    ...
    if($update_query_run)
    {
        ...
        redirect("edit-category.php?id=$category_id", "Категорията беше успешно обновена");
    }
    else
    {
        redirect("edit-category.php?id=$category_id", "Възникна някаква грешка");
    }
}
...
else if(isset($_POST['add_product_btn']))
{
    ...
    {
        move_uploaded_file($_FILES['image']['tmp_name'], $path.'/'.$filename);
        redirect("add-product.php", "Продукта беше успешно добавен");
    }
    else
    {
        redirect("add-product.php", "Възникна някаква грешка");
    }
}
else if(isset($_POST['update_product_btn']))
{
    ...
    if($update_product_query_run)
    {
        ...
        redirect("edit-product.php?id=$product_id", "Продукта обновен успешно");
    }
    else
    {
        redirect("edit-product.php?id=$product_id", "Възникна някаква грешка");
    }
}
...
else if(isset($_POST['update_order_btn']))
{
    ...
    $updateOrder_query = "UPDATE orders SET status='$order_status' WHERE tracking_number='$track_number' ";
    $updateOrder_query_run = mysqli_query($con, $updateOrder_query);

    redirect("orders.php", "Поръчката беше успешно обновена");
}
else
{
