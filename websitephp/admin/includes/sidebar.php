...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0">
      <span class="ms-1 font-weight-bold text-white">Администраторско меню</span>
    </a>
  </div>
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link text-white <?= $page == "index.php"? 'active bg-gradient-primary':''; ?>" href="index.php">
          ...
          <span class="nav-link-text ms-1">Главна страница</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white <?= $page == "category.php"? 'active bg-gradient-primary':''; ?>" href="category.php">
          ...
          <span class="nav-link-text ms-1">Всички категории</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white <?= $page == "add-category.php"? 'active bg-gradient-primary':''; ?>" href="add-category.php">
          ...
          <span class="nav-link-text ms-1">Добави категория</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white <?= $page == "products.php"? 'active bg-gradient-primary':''; ?>" href="products.php">
          ...
          <span class="nav-link-text ms-1">Всички продукти</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white <?= $page == "add-product.php"? 'active bg-gradient-primary':''; ?>" href="add-product.php">
          ...
          <span class="nav-link-text ms-1">Добави продукт</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link text-white <?= $page == "orders.php"? 'active bg-gradient-primary':''; ?>" href="orders.php">
          ...
          <span class="nav-link-text ms-1">Поръчки</span>
        </a>
      </li>
    </ul>
  </div>
  <div class="sidenav-footer position-absolute w-100 bottom-0 ">
    <div class="mx-3">
      <a class="btn bg-gradient-primary mt-4 w-100" href="../logout.php" type="button">Излизане</a>
    </div>
  </div>
</aside>