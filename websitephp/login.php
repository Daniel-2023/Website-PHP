                    ...
                    <div class="card-body">
                        <form action="functions/authcode.php" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="Въведете имейл" id="exampleInputEmail1">
                            </div>
                            <div class="mb-3">
                            ...
                            <button type="submit" name="login_btn" class="btn btn-primary">Влизане</button>
                        </form>
                    </div>
                </div>
            </div>
